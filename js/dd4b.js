//localStorage.removeItem("ESSU072P002Q03");
	...
	var dd_input = document.querySelectorAll('[data-dd-dropDown="' + a + '"]');
		...
		for(b=0;b<dd_input.length;b++){
            ...
            e.preventDefault();
                ...
                var mix = dd_lsexist[actNo] + "|" + dd_curBtn[actNo] + "|" + dd_preBtn[actNo] + "|" + dd_savedStatus[actNo];
                button4("data-dd-button","data-dd-order","data-dd-ls",mix,dd_saveBtn[actNo],actNo,"blur");
                 dd_preBtn[actNo] = "blur";
						//Your Code Here
...
for(a=0;a<dd_save.length;a++){
	...
	var dbid = dd_save[a].getAttribute("data-dd-ls");
        ...
        var actNo = a;
        var mix = dd_lsexist[actNo] + "|" + dd_curBtn[actNo] + "|" + dd_preBtn[actNo] + "|" + dd_savedStatus[actNo];
        button4("data-dd-button","data-dd-order","data-dd-ls",mix,dd_saveBtn[actNo],actNo,"refresh");
		...
		var dataOrder = document.getElementById(this.id).getAttribute("data-dd-order");
            ...
            var actNo = dataOrder;
            var mix = dd_lsexist[actNo] + "|" + dd_curBtn[actNo] + "|" + dd_preBtn[actNo] + "|" + dd_savedStatus[actNo];
            button4("data-dd-button","data-dd-order","data-dd-ls",mix,dd_saveBtn[actNo],dataOrder,"save")
...
for(a=0;a<dd_show.length;a++){
	dd_showBtn[a] = dd_show[a].getAttribute("id");
		...
		var dataOrder = document.getElementById(this.id).getAttribute("data-dd-order");
            ...
            var actNo = dataOrder;
            var mix = dd_lsexist[actNo] + "|" + dd_curBtn[actNo] + "|" + dd_preBtn[actNo] + "|" + dd_savedStatus[actNo];
            button4("data-dd-button","data-dd-order","data-dd-ls",mix,dd_saveBtn[actNo],dataOrder,"show")
...
for(a=0;a<dd_clear.length;a++){
	dd_clearBtn[a] = dd_clear[a].getAttribute("id");
		...
		var dataOrder = document.getElementById(this.id).getAttribute("data-dd-order");
            ...
            var actNo = dataOrder;
            var mix = dd_lsexist[actNo] + "|" + dd_curBtn[actNo] + "|" + dd_preBtn[actNo] + "|" + dd_savedStatus[actNo];
            button4("data-dd-button","data-dd-order","data-dd-ls",mix,dd_saveBtn[actNo],dataOrder,"clear")
...
for(a=0;a<dd_reload.length;a++){
	dd_reloadBtn[a] = dd_reload[a].getAttribute("id");
		...
		var dataOrder = document.getElementById(this.id).getAttribute("data-dd-order");
            ...
            var actNo = dataOrder;
            var mix = dd_lsexist[actNo] + "|" + dd_curBtn[actNo] + "|" + dd_preBtn[actNo] + "|" + dd_savedStatus[actNo];
            button4("data-dd-button","data-dd-order","data-dd-ls",mix,dd_saveBtn[actNo],dataOrder,"load")
...
function dd_Clear(id){
		var dataInput = document.getElementById(id).getAttribute("data-dd-order");
		var dd_input = document.querySelectorAll('[data-dd-dropDown="' + dataInput + '"]');
		var dd_answer = document.querySelectorAll('[data-dd-ShowAnswer="' + dataInput + '"]');
		...
		for(b=0;b<dd_answer.length;b++){
		dd_answer[b].style.display="none";
		}
	}
...
function dd_Show(id){
    ...
    //    dd_Clear(Id);
			...
			for(b=0;b<dd_answer.length;b++){
			dd_answer[b].style.display="block";
			}
